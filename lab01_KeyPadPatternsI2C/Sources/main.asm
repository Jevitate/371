...
;1/24/19
		...
		XDEF _Startup, main, Column, _Viic, External
...
mainLoop:
	...
	;make ptbd 0 read the analog value
	;LDA #%11101111
	;STA APCTL1
	
	;Load in Channel AD26, Math that value, 
	;load 26 into ADCSC1, value for internal SO8 temp sensor
